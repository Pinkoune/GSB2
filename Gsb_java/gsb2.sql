...
INSERT INTO `materiel` (`idMateriel`, `nomMateriel`, `typeMateriel`, `largeur`, `longueur`) VALUES
(2, 'iPad Pro 2021', 'Tablette', 12, 8),
(3, 'Galaxy S7', 'Smartphone', 5, 10);
...
INSERT INTO `vehicule` (`idVehicule`, `immat`, `modele`, `marque`, `nbPlace`) VALUES
(1, 'AC265AF', 'Model S', 'Tesla', 5);
