...
public class EmpruntAffichageVehicule extends JPanel implements ActionListener {
    ...
    //Constructeur
    public EmpruntAffichageVehicule(ArrayList < Vehicule > listeVehicule) {
        ...
        for (Vehicule monVehicule: listeVehicule) {
            ...
            data[i][4] = monVehicule.getDateDebut();
            data[i][5] = monVehicule.getDateFin();
            data[i][6] = monVehicule.getDuree();
            i++;
        }
        String[] title = {
